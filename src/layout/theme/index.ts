...
const themeColors = {
  default: {
    subMenuActiveText: '#ff7800',
    menuBg: '#fff',
    menuHover: '#f1f1f1',
    subMenuBg: '#fff',
    subMenuActiveBg: '#f1f1f1',
    menuText: '#666',
    sidebarLogo: '#fff',
    menuTitleHover: '#ff7800',
    menuActiveBefore: '#ff7800'
  },
  light: {
    subMenuActiveText: '#3e9738',
    menuBg: '#fff',
    menuHover: '#f1f1f1',
    subMenuBg: '#fff',
    subMenuActiveBg: '#f1f1f1',
    menuText: '#666',
    sidebarLogo: '#fff',
    menuTitleHover: '#3e9738',
    menuActiveBefore: '#3e9738'
  }
  // dusk: {
